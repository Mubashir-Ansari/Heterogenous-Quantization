...
def vgg11_bn(pretrained=False, progress=True, device="cpu", axx_mult = 'mul8s_acc', **kwargs):
...
def vgg13_bn(pretrained=False, progress=True, device="cpu", axx_mult = 'mul8s_acc' , **kwargs):
